...
scale.b.zustimmung <- c("Stimme völlig zu",
                        "2",
                        "3",
                        "4",
                        "5",
...
raw.short$we.Chancen <- ordered(raw.short$WE.Chancen,levels = scale.b.zustimmung)
raw.short$we.Risiken <- ordered(raw.short$WE.Chancen,levels = scale.b.zustimmung)
raw.short$we.Jobwechsel <- ordered(raw.short$WE.Jobwechsel,levels = scale.b.zustimmung)
raw.short$we.Arbeitssuche <- ordered(raw.short$WE.Arbeitssuche,levels = scale.b.zustimmung)
raw.short$as.Arbeitsplatzsicherung <- ordered(raw.short$Arbeitsplatzsicherung,levels = scale.b.zustimmung)
raw.short$`as.Vollständigkeit AufgabenBereich` <- ordered(raw.short$`Vollständigkeit AufgabenBereich`,levels = scale.b.zustimmung)
raw.short$as.Verpflichtungen <- ordered(raw.short$Verpflichtungen,levels = scale.b.zustimmung)
raw.short$as.Selbstständigkeit <- ordered(raw.short$Selbstständigkeit,levels = scale.b.zustimmung)
raw.short$as.Offenheit <- ordered(raw.short$Offenheit,levels = scale.b.zustimmung)
raw.short$ak <- ordered(raw.short$AK,levels = scale.b.zustimmung)
raw.short$ak.Arbeitsgeber <- ordered(raw.short$AK.Arbeitsgeber,levels = scale.b.zustimmung)
raw.short$ak.Arbeitskollegen <- ordered(raw.short$AK.Arbeitskollegen,levels = scale.b.zustimmung)
raw.short$ak.Chefeinschätzung <- ordered(raw.short$AK.Chefeinschätzung,levels = scale.b.zustimmung)
raw.short$ak.Coachen <- ordered(raw.short$AK.Coachen,levels = scale.b.zustimmung)
raw.short$ak.Feedback <- ordered(raw.short$AK.Feedback,levels = scale.b.zustimmung)
raw.short$ak.Inspiration <- ordered(raw.short$AK.Inspiration,levels = scale.b.zustimmung)
raw.short$ak.Ratfragen <- ordered(raw.short$AK.Ratfragen,levels = scale.b.zustimmung)
raw.short$aa.Arbeitsplatzsicherung2 <- ordered(raw.short$AA.Arbeitsplatzsicherung2,levels = scale.b.zustimmung)
raw.short$aa.B.Herausforderung <- ordered(raw.short$AA.B.Herausforderung,levels = scale.b.zustimmung)
raw.short$aa.Challenge <- ordered(raw.short$AA.Challenge,levels = scale.b.zustimmung)
raw.short$aa.Entwicklung <- ordered(raw.short$AA.Entwicklung,levels = scale.b.zustimmung)
raw.short$aa.Herausforderung <- ordered(raw.short$AA.Herausforderung,levels = scale.b.zustimmung)
raw.short$aa.Proaktiv <- ordered(raw.short$AA.Proaktiv,levels = scale.b.zustimmung)
raw.short$aa.Projekte <- ordered(raw.short$AA.Projekte,levels = scale.b.zustimmung)
raw.short$`aa.Stress Herausf.` <- ordered(raw.short$`AA.Stress Herausf.`,levels = scale.b.zustimmung)
raw.short$aa.Übermotivation <- ordered(raw.short$AA.Übermotivation,levels = scale.b.zustimmung)
raw.short$am.Arbeitgeber <- ordered(raw.short$AM.Arbeitgeber,levels = scale.b.zustimmung)
raw.short$am.Arbeitskollegen <- ordered(raw.short$AM.Arbeitskollegen,levels = scale.b.zustimmung)
raw.short$am.Bekannte <- ordered(raw.short$AM.Bekannte,levels = scale.b.zustimmung)
raw.short$am.Selbst <- ordered(raw.short$AM.Selbst,levels = scale.b.zustimmung)
raw.short$`ko.Leistungsdruck Konkurrenz` <- ordered(raw.short$`Leistungsdruck Konkurrenz`,levels = scale.b.zustimmung)
raw.short$`ko.Motivation Konkurrenz` <- ordered(raw.short$`Motivation Konkurrenz`,levels = scale.b.zustimmung)
raw.short$`wlb.Arbeit/PL` <- ordered(raw.short$`WLB.Arbeit/PL`,levels = scale.b.zustimmung)
raw.short$`wlb.Arbeit nach Feierabend` <- ordered(raw.short$`WLB.Arbeit nach Feierabend`,levels = scale.b.zustimmung)
raw.short$wlb.Arbeitstier <- ordered(raw.short$WLB.Arbeitstier,levels = scale.b.zustimmung)
raw.short$`wlb.Emails Feierabend` <- ordered(raw.short$`WLB.Emails Feierabend`,levels = scale.b.zustimmung)
raw.short$wlb.Familienmensch <- ordered(raw.short$WLB.Familienmensch,levels = scale.b.zustimmung)
raw.short$`wlb.Gedanken Arbeit` <- ordered(raw.short$`WLB.Gedanken Arbeit`,levels = scale.b.zustimmung)
raw.short$`wlb.Genug Freizeit` <- ordered(raw.short$`WLB.Genug Freizeit`,levels = scale.b.zustimmung)
raw.short$wlb.Hobbys <- ordered(raw.short$WLB.Hobbys,levels = scale.b.zustimmung)
raw.short$wlb.Ruhephasen <- ordered(raw.short$WLB.Ruhephasen,levels = scale.b.zustimmung)
raw.short$`wlb.Stress/Arbeit` <- ordered(raw.short$`WLB.Stress/Arbeit`,levels = scale.b.zustimmung)
raw.short$`wlb.Stress/Umgang` <- ordered(raw.short$`WLB.Stress/Umgang`,levels = scale.b.zustimmung)
raw.short$`wlb.Vereinbarung A/PL` <- ordered(raw.short$`WLB.Vereinbarung A/PL`,levels = scale.b.zustimmung)
raw.short$wlb.Wunschfreizeit <- ordered(raw.short$WLB.Wunschfreizeit,levels = scale.b.zustimmung)
raw.short$wlb.Erreichbarkeit <- ordered(raw.short$WLB.Erreichbarkeit,levels = scale.b.zustimmung)
